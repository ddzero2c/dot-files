...
local function apply_theme()
  if vim.o.background == 'dark' then
    ...
    vim.api.nvim_set_hl(0, 'DiffAdd', { bg = '#DBEDFF' })
    vim.api.nvim_set_hl(0, 'DiffDelete', { bg = '#FFDCDC' })
    vim.api.nvim_set_hl(0, 'DiffChange', { bg = '#DBEDFF' })
    vim.api.nvim_set_hl(0, 'DiffText', { bg = '#B3D9FF' })
