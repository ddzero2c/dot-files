---
description: Review changed files for reuse, quality, and efficiency, then fix what's found
argument-hint: [optional scope, e.g. "review whole api"]
---
...
If the user passed arguments, use them to scope or redirect the review: $ARGUMENTS
